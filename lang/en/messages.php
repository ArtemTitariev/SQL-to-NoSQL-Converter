...
return [
    ...
    'select_tables_policy' => "At this step, you can select the tables whose data you want to convert. For most columns, you can change the data type as needed. Please note: you can set up the organization of relationships between tables in the next step.",
];