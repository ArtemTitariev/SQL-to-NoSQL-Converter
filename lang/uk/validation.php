...
return [
    ...
    */
    ...
    'required_columns' => "Виберіть типи даних для всіх стовпців.",
    ...
    'required_tables' => "Вибрані не всі необхідні таблиці.",
    'required_table' => "Виберіть хоча б одну таблицю.",
    'required_table_in_columns' => "Таблиця :table відсутня у масиві стовпців.",
    ...
    'superfluous_column' => 'Стовпець :column не знайдено в таблиці :table.',
    'superfluous_columns' => 'Схоже, ви вручну додали стовпці. Їх немає в схемі.',
    'superfluous_datatypes' => 'Схоже, ви вручну додали тип даних для стовпця таблиці. Цей тип даних не може бути використаний.',
    'superfluous_tables' => 'Схоже, ви вручну додали нові таблиці. Їх немає в схемі.',
