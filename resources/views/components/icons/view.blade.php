<svg fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg"
    xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 80.794 80.794" xml:space="preserve" stroke="#000000"
    stroke-width="0.00080794" {{ $attributes->merge(['class' => 'h-6 w-6']) }}>
