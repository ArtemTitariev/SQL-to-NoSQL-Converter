            ...
            <table
                ...
                <tr>
                    <td style="text-align: center; padding-bottom: 30px;">
                        <h1 style="font-size: 32px; color: #DC3545; font-family: 'Open Sans', Arial, sans-serif;">На
                            жаль, процес конвертування не вдалося завершити</h1>
                    </td>
                </tr>
                <tr>
                    <td>
                        <p style="font-size: 18px; color: #374151; font-family: 'Open Sans', Arial, sans-serif;">Шановний
                            користувачу,</p>
                        <p style="font-size: 18px; color: #374151; font-family: 'Open Sans', Arial, sans-serif;">Змушені
                            повідомити, що процес конвертування вашої реляційної бази даних у нереляційну не вдалося
                            завершити.</p>
                        <p style="font-size: 18px; color: #374151; font-family: 'Open Sans', Arial, sans-serif;">
                            {{ $errorMessage }}</p>
                        <p style="font-size: 18px; color: #374151; font-family: 'Open Sans', Arial, sans-serif;">Будь
                            ласка, перевірте конфігурацію вашої бази даних.</p>
                        ...
                        <p style="font-size: 18px; color: #374151; font-family: 'Open Sans', Arial, sans-serif;">
                            Приносимо вибачення за незручності.</p>
                    </td>
                </tr>
                <tr>
